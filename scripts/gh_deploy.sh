#!/bin/bash
PROJECT_NAME="BE-PopcornPicks-"
JAR_PATH="/home/ec2-user/BE-PopcornPicks-/build/libs/*.jar"
...
nohup java -jar -Dspring.profiles.active=local $DEPLOY_JAR --server.port=3000 >> $APPLICATION_LOG_PATH 2> $DEPLOY_ERR_LOG_PATH &
